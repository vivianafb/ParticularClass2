...
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'css', 'images')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'fonts')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'js')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'js', 'ie')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'assets', 'sass')
